...
class ProcessCategoryImport
{
    ...
    public function execute(): void
    {
        ...
        try {
            ...
            if ($processed) {
                $this->logger->info(sprintf('Vendit cron: processed %d category import file(s)', $processed));
            }
        } catch (\Exception $e) {
            $this->logger->error('Vendit category import cron error: ' . $e->getMessage(), [
                'exception' => $e,
            ]);
        }
    }

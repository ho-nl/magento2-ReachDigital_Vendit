...
class ProcessStockImport
{
    ...
    public function execute(): void
    {
        ...
        try {
            ...
            if ($processed) {
                $this->logger->info(sprintf('Vendit cron: processed %d stock import file(s)', $processed));
            }
        } catch (\Exception $e) {
            $this->logger->error('Vendit stock import cron error: ' . $e->getMessage(), [
                'exception' => $e,
            ]);
        }
    }
